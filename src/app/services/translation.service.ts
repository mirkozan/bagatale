...
const hu: Dictionary = {
  ...
  'contact.eyebrow':'Dolgozzunk együtt','contact.title':'Van egy történeted?','contact.lead':'Írj pár sort róla. Minden jó projekt egy beszélgetéssel kezdődik.','contact.name':'Név','contact.email':'Email cím','contact.message':'Üzenet','contact.send':'Üzenet küldése','contact.success':'Köszönjük! Megkaptuk az üzeneted, hamarosan jelentkezünk.','contact.required':'Kérjük, töltsd ki ezt a mezőt.','footer.line':'Mozgó képek.','footer.youtube':'YouTube csatorna','footer.facebook':'Facebook oldal'
};
const en: Dictionary = {
