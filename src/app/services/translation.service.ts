...
const hu: Dictionary = {
  ...
  'contact.eyebrow':'Dolgozzunk együtt','contact.title':'Van egy történeted?','contact.lead':'Írj pár sort róla. Minden jó projekt egy beszélgetéssel kezdődik.','contact.name':'Név','contact.email':'Email cím','contact.message':'Üzenet','contact.send':'Üzenet küldése','contact.success':'Köszönjük! Megkaptuk az üzeneted, hamarosan jelentkezünk.','contact.error':'Az üzenetet nem sikerült elküldeni. Kérjük, próbáld újra.','contact.required':'Kérjük, töltsd ki ezt a mezőt.','footer.line':'Mozgó képek.','footer.youtube':'YouTube csatorna','footer.facebook':'Facebook oldal'
};
const en: Dictionary = {
  ...
  'contact.eyebrow':'Let’s work together','contact.title':'Have a story to tell?','contact.lead':'Send us a few lines. Every good project starts with a conversation.','contact.name':'Name','contact.email':'Email address','contact.message':'Message','contact.send':'Send message','contact.success':'Thank you! We received your message and will be in touch soon.','contact.error':'Your message could not be sent. Please try again.','contact.required':'Please fill out this field.','footer.line':'Pictures in motion.','footer.youtube':'YouTube channel','footer.facebook':'Facebook page'
};
...
export class TranslationService {
  ...
  t(key: string): string { return this.dictionaries[this.language()][key] ?? key; }
