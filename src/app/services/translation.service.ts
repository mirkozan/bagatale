...
const hu: Dictionary = {
  ...
  'home.eyebrow':'Kreatív produkció · Budapest','home.title':'Történetek, amik veled maradnak.','home.lead':'A Bagatale Productions filmeket, videókat és vizuális történeteket készít — őszintén, játékosan, részletekre figyelve.','home.about':'Ismerj meg minket','home.videos':'Videók','home.contact':'Beszéljünk','home.note':'Friss ötletek, jó emberek, valódi történetek.','home.scroll':'Görgess tovább',
  ...
  'videos.eyebrow':'Nézd meg','videos.title':'Képek mozgásban.','videos.lead':'Néhány történet, amit örömmel készítettünk.','videos.watch':'Megnézem YouTube-on',
  'contact.eyebrow':'Dolgozzunk együtt','contact.title':'Van egy történeted?','contact.lead':'Írj pár sort róla. Minden jó projekt egy beszélgetéssel kezdődik.','contact.name':'Név','contact.email':'Email cím','contact.message':'Üzenet','contact.send':'Üzenet küldése','contact.success':'Köszönjük! Megkaptuk az üzeneted, hamarosan jelentkezünk.','contact.required':'Kérjük, töltsd ki ezt a mezőt.','footer.line':'Történetek, képek és hangok.'
};
const en: Dictionary = {
  'nav.home':'Home','nav.about':'About','nav.videos':'Videos','nav.contact':'Contact','nav.menu':'Menu',
  'home.eyebrow':'Creative production · Budapest','home.title':'Stories that stay with you.','home.lead':'Bagatale Productions makes films, videos and visual stories — honestly, playfully, with an eye for detail.','home.about':'Meet the team','home.videos':'Watch videos','home.contact':'Let’s talk','home.note':'Fresh ideas, good people, real stories.','home.scroll':'Scroll to explore',
  ...
  'videos.eyebrow':'Take a look','videos.title':'Pictures in motion.','videos.lead':'A few stories we were happy to make.','videos.watch':'Watch on YouTube',
  'contact.eyebrow':'Let’s work together','contact.title':'Have a story to tell?','contact.lead':'Send us a few lines. Every good project starts with a conversation.','contact.name':'Name','contact.email':'Email address','contact.message':'Message','contact.send':'Send message','contact.success':'Thank you! We received your message and will be in touch soon.','contact.required':'Please fill out this field.','footer.line':'Stories, pictures and sound.'
};
